...
public sealed class PiChatActor : PiActor<BpHogWarpChat>
{
	...
	public async Task SendMessageToPlayer(HPlayer player, string message) => WorldActor.RecieveMsg(player, message);
	...
	public void PlayerMessageReceived(HPlayer player, string message)
	{
